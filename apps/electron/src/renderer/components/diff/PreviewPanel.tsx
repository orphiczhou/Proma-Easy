  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-content-area titlebar-no-drag">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        {currentFile ? (
          <PreviewContentErrorBoundary resetKey={`${sessionId}:${currentFile.filePath}:${currentFile.previewVersion ?? 0}`}>
            <DiffTabContent
              key={`${sessionId}:${currentFile.filePath}:${currentFile.previewVersion ?? 0}`}
