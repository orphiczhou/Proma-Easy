...
describe('序列与 guide-dsl 节点对齐（跨进程契约锁定）', () => {
  ...
  const route = [
    ...
    { id: 'coding', role: 'fullstack-developer', title: '全栈开发', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '08_APP/index.html', constraints: [], requiresUserConfirmation: true, requiresAC: false, retryLimit: 2, next: 'testing', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5.3-flash' } } },
    { id: 'testing', role: 'test-engineer', title: '测试工程师', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '06_TESTS/features/index.feature', constraints: [], requiresUserConfirmation: false, requiresAC: false, retryLimit: 2, next: 'delivered', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5.3-flash' } } },
  ]
