...
describe('序列与 guide-dsl 节点对齐（跨进程契约锁定）', () => {
  ...
  const route = [
    { id: 'requirements', role: 'requirement-analyst', title: '需求分析师', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '01_PRD/prd.md', constraints: [], requiresUserConfirmation: true, requiresAC: false, retryLimit: 3, next: 'prototype', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
    { id: 'prototype', role: 'ux-advisor', title: 'UX 顾问', channel: 'minimax', model: 'MiniMax-M3', task: '', outputPath: '02_UX_DESIGN/prototype.html', constraints: [], requiresUserConfirmation: true, requiresAC: true, retryLimit: 2, next: 'architecture', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
    { id: 'architecture', role: 'architect', title: '架构师', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '03_ARCHITECTURE/architecture.md', constraints: [], requiresUserConfirmation: true, requiresAC: true, retryLimit: 2, next: 'planning', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
    { id: 'planning', role: 'engineering-manager', title: '工程经理', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '05_PROJECT_PLAN/plan.md', constraints: [], requiresUserConfirmation: true, requiresAC: false, retryLimit: 2, next: 'coding', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
    { id: 'coding', role: 'fullstack-developer', title: '全栈开发', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '08_APP/index.html', constraints: [], requiresUserConfirmation: true, requiresAC: false, retryLimit: 2, next: 'testing', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
    { id: 'testing', role: 'test-engineer', title: '测试工程师', channel: 'deepseek', model: 'deepseek-v4-pro', task: '', outputPath: '06_TESTS/features/index.feature', constraints: [], requiresUserConfirmation: false, requiresAC: false, retryLimit: 2, next: 'delivered', acActors: { attacker: { channel: 'deepseek', model: 'deepseek-v4-flash' }, defender: { channel: 'glm-zhipu', model: 'glm-5-turbo' } } },
  ]
